...
bc. $ sudo docker build --build-arg USER_ID=<you-user-id-on-host> --build-arg GROUP_ID=<your-group-id-on-host> -t <you-image-name-here> .

h3. example

bc. $ sudo docker build --build-arg USER_ID=1000 --build-arg GROUP_ID=1000 -t scto-php:7.4 .
